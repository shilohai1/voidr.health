...
const SearchComponent = ({ placeholder = "Enter your topic or question..." }: { placeholder?: string }) => {
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[500px] rounded-xl blur-[3px] 
                        ...
                        before:bg-[conic-gradient(#000,#e6f6fa_5%,#000_38%,#000_50%,#f3fceb_60%,#000_87%)] before:transition-all before:duration-2000
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[489px] rounded-xl blur-[0.5px] 
                        ...
                        before:bg-[conic-gradient(#1c191c,#e6f6fa_5%,#1c191c_14%,#1c191c_50%,#f3fceb_60%,#1c191c_64%)] before:brightness-130
        ...
        <div id="main" className="relative group">
          <input placeholder={placeholder} type="text" name="text" className="bg-[#ebf5f3] border-none w-[387px] h-[56px] rounded-lg text-black px-[59px] text-lg focus:outline-none placeholder-gray-400" />
          <div id="input-mask" className="pointer-events-none w-[100px] h-[20px] absolute bg-gradient-to-r from-transparent top-[18px] left-[70px] group-focus-within:hidden"></div>
          <div id="pink-mask" className="pointer-events-none w-[30px] h-[20px] absolute bg-[#f3fceb] top-[10px] left-[5px] blur-2xl opacity-80 transition-all duration-2000 group-hover:opacity-0"></div>
