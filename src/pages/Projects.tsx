        ...
        <div className="container mx-auto px-4 py-8 lg:py-12">
          <div className="max-w-6xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-base text-black">All your generated videos, notes, and documents</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.map((project) => (
                <LiquidCard key={project.id} className="p-6 bg-white">
                  <div className="space-y-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-black mb-1 text-base">{project.title}</h3>
